function [qMatrix, newSteps]=shot(robot, offset, time)
% for edge shot, offset should be 1 & time should be 4; for corner offset
% should be 0 and time should be 8
...
tr=robot.model.fkine(robot.model.getpos())*transl(0,0,0);
...
for i=2:steps
    x(1,i) = x(1,i-offset)-0.001; % Points in x
